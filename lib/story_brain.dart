import 'package:destinity/story.dart';
...
class StoryBrain {
  ...
  void nextStory(int choiceNumber) {
    if (choiceNumber < 3) {
      traitement(0, choiceNumber, 2, 1);
      traitement(1, choiceNumber, 2, 3);
      traitement(2, choiceNumber, 5, 4);
    } else {
      restart();
    }
  }
  ...
  void traitement(int etape, int choix, int res1, res2) {
    if (choix == 1) {
      _storyNumber = res1;
    } else {
      _storyNumber = res2;
